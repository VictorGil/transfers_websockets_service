 ...
 */
public class AccountBalanceConsumerImpl implements AccountBalanceConsumer{

    private static final Logger log = LoggerFactory.getLogger(AccountBalanceConsumerImpl.class);
